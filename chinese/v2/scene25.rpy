...
translate chinese v2s25_a9997c21:
    ...
    admin "好极了。我为你们预定了贵宾区我们会派最好的豪华轿车让你们都能体面地到达。"
...
translate chinese v2s25_4ffab0d1:
    ...
    admin "太好了! 我必须指出，即使你们中的一个未成年，我们也不允许提供酒精饮料。"
...
translate chinese v2s25_2ade84bf:
    ...
    u "我们的大学正在举行总统选举，如果一切顺利，这将有助于赢得一些有影响力的人的选票。"
...
translate chinese v2s25_8381da7b:
    ...
    admin "听起来不错，亲爱的，但如果你未成年，我们不能给你酒，就这么简单。"
...
translate chinese v2s25_7b71c1b5:
    ...
    u "这是为了我的朋友 Lindsey 我只是想尽我所能帮助她。"
...
translate chinese v2s25_d15b214b:
    ...
    u "她真的配得上当总统，她真的可以提升女生联谊会里每个人的生活。"
...
translate chinese v2s25_0864c408:
    ...
    admin "我妈妈去世后，我保持了一些新的兴趣爱好，这对我很有帮助。听起来你的朋友也在做同样的事。"
...
translate chinese v2s25_bcedf10b:
    ...
    admin "我就不打勾了这样你们就能喝点酒没人会检查你们的身份证，好吗？"
...
translate chinese v2s25_98e70f5f:
    ...
    u "从法律上讲，我们可以喝几杯然后再看看今晚怎么样。听起来怎么样？"
...
translate chinese v2s25_4a1da67c:
    ...
    admin "所以，整个聚会的费用是800美元。你一到就得付钱。"
...
translate chinese v2s25_c2c0b547:
    ...
    admin "所以，全套 VIP 派对套餐，不含酒精，一共700美元。你一到就得付钱。"
...
translate chinese v2s25_013f2a9f:
    ...
    admin "太好了！我要说的就是，感谢您选择芒果酒吧 VIP 派对套餐！祝你今天愉快！"
...
translate chinese v2s25_b3f2e1ec:
    ...
    admin "这是 VIP 派对套餐，专为有钱享受 VIP 生活的人设计的。"
...
translate chinese v2s25_9af61382:
    ...
    admin "是的，我们不能给您提供任何酒精饮料，但您仍然可以得到一系列的鸡尾酒，苏打水和果汁都包括在内。"
...
translate chinese v2s25_6c208ea3:
    ...
    admin "你仍然可以选择一系列的鸡尾酒，苏打水和果汁，都包括在价格内。"
...
translate chinese v2s25_01c810bc:
    ...
    admin "我可以给你25% 的折扣，这样价格就降到600美元了。"
...
translate chinese v2s25_02be77ed:
    ...
    admin "哈，对不起，已经过时了。我相信不管怎样你都会玩得很开心的。"
