...
translate chinese v2s22_b0a5a9a2:
    ...
    u "- 我只是觉得 Nora 的事在她脑子里挥之不去-我觉得你最好离开这个房间。"
...
translate chinese v2s22_fecb5455:
    ...
    cl "我以为罗斯老师会帮我保住奖学金。我不知道如果我失去了它，我该怎么办。"
...
translate chinese v2s22_9d6f6855:
    ...
    cl "真不敢相信我们没有署名就去找院长了，我以为我们有很好的案子。"
...
translate chinese v2s22_fa536c80:
    ...
    cl "不过，他们还是可以签约的，他们没什么可失去的，我可能会失去一切。"
...
translate chinese v2s22_724917ab:
    ...
    cl "我们不会带着这些笔记的。我不想让我们分心我也不想冒险惹毛她，所以..。"
...
translate chinese v2s22_0ad4d4db:
    ...
    de "让你久等了。我得说这来得不是时候因为兄弟会的学生行为审查。"
...
translate chinese v2s22_10b4be12:
    ...
    u "李先生认为我们对这项建议有良好的意图，并相信它将有利于 SVC。"
...
translate chinese v2s22_1c359e1e:
    ...
    u "罗斯女士认为，这不仅是一个伟大的建议，为小鸡，但它将有利于 SVC 的整体。"
...
translate chinese v2s22_308cc8a7:
    ...
    de "我无法想象你说的是我在 SVC 的任何一位老师,[name]."
...
translate chinese v2s22_8ea39673:
    ...
    de "好吧，撇开责备不谈，我会给你一个公平的机会，所以现在你是来说服我的。"
...
translate chinese v2s22_e27f87fe:
    ...
    de "我需要确定这个提议对每个人都有好处 Chloe 不只是对小妞们。"
...
translate chinese v2s22_32686599:
    ...
    u "基本上，我们认为你应该同意这个建议，因为从长远来看，它将吸引更多的学生到 SVC。"
...
translate chinese v2s22_a570319e:
    ...
    u "这将鼓励其他女生联谊会和兄弟会希望得到和小鸡队一样的待遇。"
...
translate chinese v2s22_50c4a778:
    ...
    u "它还鼓励贫困人口申请。随着学费的降低，他们可能会觉得自己能够负担得起大学教育。"
...
translate chinese v2s22_d4f9e020:
    ...
    u "为了公平起见，其他姐妹会和兄弟会，当他们看到小鸡队领先时，他们也会想要同样的待遇。"
...
translate chinese v2s22_0ef19b2c:
    ...
    u "这将使他们提高他们的游戏，并作为领导者和学生更加努力地工作。"
...
translate chinese v2s22_f64e4491:
    ...
    cl "随着学费的全面降低，这将有助于我们鼓励更多人注册的第一点。"
...
translate chinese v2s22_c114a882:
    ...
    de "我想知道你怎么解释这一点，但他们需要更加努力工作是有道理的。"
...
translate chinese v2s22_02e1e6c5:
    ...
    u "你还应该知道克洛伊已经同意放弃她的奖学金作为求婚的一部分。"
...
translate chinese v2s22_017031c3:
    ...
    de "然而，我知道你们都是 SVC 很有影响力的学生，这总会给事业增加一定的动力。"
...
translate chinese v2s22_5a301f01:
    ...
    de "当我考虑你今天所说的一切的时候，我觉得你还不够好。我觉得你还没有想清楚。"
...
translate chinese v2s22_3064ef07:
    ...
    de "你们都是很有影响力的学生，我认为这有助于你们在这个提案上的立场，但是..。"
...
translate chinese v2dean_successful_60593c68:
    ...
    de "我很乐意继续为小妞们减少学费。我们可以用你的联谊会做个案例研究，看看结果如何。"
...
translate chinese v2dean_unsuccessful_a2b56440:
    ...
    cl "我们甚至得到了 Rose 女士的支持，所有的努力... 都白费了。"
