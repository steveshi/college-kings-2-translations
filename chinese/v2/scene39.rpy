...
translate chinese v2s39_3e813e9a:
    ...
    bartender "今晚我们为您准备了全套饮料，从啤酒到普罗塞克，到龙舌兰，甚至鸡尾酒，都包含在贵宾派对套餐里。"
...
translate chinese v2s39_d7a46ee6:
    ...
    bartender "我被告知你还未成年所以尽管我们不能给你提供我们正常的酒鬼名单。"
...
translate chinese v2s39_72a404b1:
    ...
    se "哦，是的。我和这些人打了好几个小时的电话，想要更便宜的价格。差不多有一千块。"
...
translate chinese v2s39_eb02c470:
    ...
    u "(今晚似乎进展顺利，但林赛没有提到任何关于获得他们支持的事情... ...)"
...
translate chinese v2s39_8014b19c:
    ...
    li "嘿，各位，我想谢谢你们过来跟我说点严肃的事情，很快的，然后我们就可以直接回去找乐子了，好吗？"
...
translate chinese v2s39_574a29ef:
    ...
    u "(即使我们刚刚得到狼队对克洛伊竞选的支持，他仍然在这里支持他的朋友。)"
...
translate chinese v2s39_a493bc4f:
    ...
    u "(尽管克洛伊刚刚宣布狼队正式成为她的兄弟，他仍然在这里为他的朋友。)"
...
translate chinese v2s39_e11a49dc:
    ...
    aut "听听她要说什么 Grayson 我们都经历过她的处境。"
...
translate chinese v2s39_9a929e0d:
    ...
    se "我不能评论，我不太了解她，我们不怎么说话，所以严格来说，没什么。"
...
translate chinese v2s39_b287d10d:
    ...
    se "我的意思是，再说一次，不是很多。我想我可能对克洛伊没什么好说的但至少有几件关于你的好事要说。"
...
translate chinese v2s39_d98e95e4:
    ...
    u "(这将是一个好时机尝试和记录林赛说一些特别婊子关于克洛伊。希望我能抓到些有用的东西。)"
...
translate chinese v2s39_ed05ea84:
    ...
    aut "Chloe 对我很好，她以前帮过我一些忙，但是... 最近没什么事。"
...
translate chinese v2s39_51f3c949:
    ...
    aut "我已经邀请她参加一些鹿的活动，但她总是放我鸽子。通常连道歉的信息都没有。"
...
translate chinese v2s39_d998e4f7:
    ...
    li "小妞们的总统应该支持你所有的活动，奥特姆，你难道不希望这样吗？"
...
translate chinese v2s39_4e43e683:
    ...
    li "对我来说，支持其他姐妹会对每个人都有好处这就是为什么我们都在这里，对吗？"
...
translate chinese v2s39_a01f55eb:
    ...
    au "但是我必须同意你的观点 Lindsey 你的观点很有道理。"
...
translate chinese v2s39_64d1d42f:
    ...
    u "(如果 Lindsey 喝得更多，她就更有可能说漏嘴，喝一杯?)"
...
translate chinese v2s39_c0b3282c:
    ...
    li "我已经醉了,[name]。我不认为我可以处理另一个镜头，哈哈。"
...
translate chinese v2s39_stop_lindsey_12177cfa:
    ...
    li "哦，哦，是的，我很抱歉，那听起来一定很贱，对不起，各位。"
...
translate chinese v2s39_stop_lindsey_370dd210:
    ...
    u "(妈的，太棒了! 谢谢你 Lindsey Chloe 会欣喜若狂的)"
...
translate chinese v2s39_stop_lindsey_5058906d:
    ...
    u "(没有酒精会很困难。我可以试着欺骗琳赛，但是... ... 如果她在清醒的时候出错，我会非常惊讶的。)"
...
translate chinese v2s39_stop_lindsey_fad85dba:
    ...
    li "我不恨她,[name]。克洛伊是一个女孩，并将永远是姐妹会的姐妹。"
...
translate chinese v2s39_stop_lindsey_c21f0f74:
    ...
    au "当然，既然你赢得了我们的心我们能谈点别的吗？还是去跳舞？"
