...
translate chinese v2s12_f8051460:
    ...
    li "她想骗我[name]这样她就可以公开让我难堪... 你能相信吗？"
...
translate chinese v2s12_423d9fad:
    ...
    li "我很高兴我提前得到了这个信息，谁知道我刚刚避免了什么样的麻烦。"
...
translate chinese v2s12_26589a2b:
    ...
    li "我得承认，我需要钱才能赢。所以我们才有她的日记。但是克洛伊有钱，有资源。"
...
translate chinese v2s12_568c7465:
    ...
    li "我猜到了这一步，他不会让她去任何地方除非告诉他她要去哪里，和谁一起。"
...
translate chinese v2s12_87e2f7c0:
    ...
    li "过了一段时间，她意识到如果她不想整天被吼和不被信任，她就必须停止和他约会。"
...
translate chinese v2s12_1090a9c3:
    ...
    li "但公平地说，这只是故事的一面。我猜你得偷格雷森的日记才能知道全部情况？"
...
translate chinese v2s12_ab3c4816:
    ...
    li "我只想知道你对她是不是认真的因为如果你是认真的，那我们应该..。"
...
translate chinese v2s12_b1b78f6e:
    ...
    li "我们可以信任的盟友，在选举期间支持我们，在未来，当我成为小鸡队主席的时候也支持我们。"
...
translate chinese v2s12_a3551496:
    ...
    li "我有个很棒的主意组织一个 VIP 之夜但是我已经查过了，实际上我负担不起。"
...
translate chinese v2s12_672c5ef1:
    ...
    li "我知道你冒了很大的风险搜查克洛伊的房间但这些东西太贵了。"
...
translate chinese v2s12_93421352:
    ...
    li "我们只是没有得到一个足够好的报价在汽车，但希望我们可以把这笔钱在未来的良好用途。"
...
translate chinese v2s12_05fb6a4d:
    ...
    li "所以基本上，这就是你认为应该来的人，以及获得他们支持的最好方式。"
...
translate chinese v2s12_fd3fa15c:
    ...
    u "他们都是好主意，我想我们可以和俱乐部一起去，或者无论如何都是一个游戏之夜，最后还是会有一段美好的时光..。"
...
translate chinese v2s12_12d63199:
    ...
    u "但在你开着豪华轿车带她们出去过夜之后她们就不可能支持克洛伊了。"
...
translate chinese v2s12_dd543e97:
    ...
    u "克洛伊刚刚宣布狼队是她的正式兄弟会，但是塞巴斯蒂安在那里肯定会让他们质疑。"
...
translate chinese v2s12_41c2ea56:
    ...
    u "(该死的，是吗? 我做了什么? 我们真的不需要在家里再有更多的闹剧了...)"
...
translate chinese v2s12_54496649:
    ...
    u "克洛伊刚刚宣布狼人是她的正式兄弟所以我们现在得把注意力集中在猩猩身上。"
...
translate chinese v2s12_f3e65369:
    ...
    u "(让猩猩们支持克洛伊，现在试图让塞巴斯蒂安影响狼队，我要让所有人都参与进来!)"
