...
translate chinese v2s6_f1828e9d:
    ...
    cl "他们在我房间里！如果他们在我睡觉的时候出现了呢？我现在可能已经死了"
...
translate chinese v2s6_21657167:
    ...
    cl "有人闯进我的房间，然后... * 啜泣 * 他们从我钱包里拿走了三百美元..。"
...
translate chinese v2s6_2ea0755c:
    ...
    cl "虽然不是世界末日，但它们还是在我房间里，有人在我房间里..。"
...
translate chinese v2s6_5614616e:
    ...
    cl "他们全拿走了,[name]. 我所有的竞选经费... 都没了! * 啜泣 * "
...
translate chinese v2s6_7d3394e7:
    ...
    cl "我把它们都放在房间里，意思是... 有人进去拿走了，全都不见了！"
...
translate chinese v2s6_705daadd:
    ...
    cl "我觉得自己内心完全赤裸了，因为我知道可能有别人正在读这篇文章"
...
translate chinese v2s6_237a4899:
    ...
    u "只要你继续朝着你的目标前进，那就是成为小妞们的总统... 那就是你的目标，对吧？"
...
translate chinese v2s6_ebdb97aa:
    ...
    cl "我该怎么办？我真的被抢了！我要进行全面调查还是这会给我带来更大的压力？"
...
translate chinese v2s6_aff97532:
    ...
    u "克洛伊？你为什么这么在意两个随机的人支持你？不是只有小鸡才有投票权吗？"
...
translate chinese v2s6_ce20289e:
    ...
    cl "是啊，但是每个女生都有女生联谊会以外的朋友。他们中的每一个人都会受到公众舆论的影响。"
...
translate chinese v2s6_004e56b5:
    ...
    cl "这就是为什么学校里的每个人都支持我而不是 Lindsey 的原因，不仅仅是 Chicks。"
