...
translate chinese v3s34_e7819425:
    ...
    u "如果是以利亚放进去的他难道不想遵守他那奇怪的以利亚规则吗？"
...
translate chinese v3s34_fc7d01b0:
    ...
    cl "是的，我非常坚定。我只是需要一些帮助来向 SVC 证明我是最尽职尽责的候选人。"
...
translate chinese v3s34_7c495108:
    ...
    cl "根据目前对 SVC 报纸的大肆宣传，我可以断定你的第一版将会大获成功。"
...
translate chinese v3s34_d019e734:
    ...
    cl "当然是在你的帮助下。但没错，这是制作封面的绝佳机会让 SVC 看看我的真面目。"
...
translate chinese v3s34_f6d26f76:
    ...
    el "* 笑声 * 你觉得我会因为自豪而破坏我第一期官方论文的公正性吗？"
...
translate chinese v3s34_162c44df:
    ...
    el "我们以前没怎么说过话,[name]但是当我们做的时候，你总是抓住机会取笑我。"
...
translate chinese v3s34_807c9651:
    ...
    el "在我看来，这对克洛伊来说是件大事而我帮她这个忙就是在损害我的新闻正直。"
...
translate chinese v3s34_a0835e7d:
    ...
    u "(哦，是的，他妈的。 SVC 时报是正确的那里与布拉芬顿邮报。)"
...
translate chinese v3s34_d99b8682:
    ...
    u "你很幸运 Chloe 需要你，你个狗娘养的，因为我想把你的头伸进监视器。"
...
translate chinese v3s34_dea597f5:
    ...
    cl "等等，你这个疯子。第二个选择肯定意味着没有封面，虽然。所以，说真的... 你觉得呢？"
...
translate chinese v3s34_ed1366ff:
    ...
    cl "唉，现在我至少可以把这个从清单上划掉了，在今晚之前，我还有20多件事要做。"
...
translate chinese v3s34_16dfb535:
    ...
    cl "我还在考虑是把你的要求告诉院长还是直接告诉 SVC 的其他人。"
...
translate chinese v3s34_e97bc913:
    ...
    cl "哦，我们不会的，但是小鸡队的骨干们会的。祝你好运，罗斯先生! 再见，变态。"
...
translate chinese v3s34_05ad19ed:
    ...
    cl "唉，现在我可以把这个从清单上划掉了，在今晚之前我还有20多件事要做。"
