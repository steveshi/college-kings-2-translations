...
translate chinese v3s60_61e03a5d:
    ...
    el "这里有一个有趣的问题: 你钦佩你的总统竞选对手的什么地方？"

# game/v3/scene60.rpy:122
translate chinese v3s60_120bbfa3:
...
translate chinese v3s60_2e8be11d:
    ...
    li "我想可以说我们已经形成了竞争关系但我仍然把克洛伊当作我的朋友一直把她当作我的姐妹会姐妹。"
...
translate chinese v3s60_50487cb6:
    ...
    el "我知道大家会想听听你的想法。你是否觉得每个成功的总统都应该具备某种特定的品质？"
...
translate chinese v3s60_b19b67db:
    ...
    li "但是为了给出一个更具体的答案，我想说一个好的总统需要是一个有效的沟通者。"
...
translate chinese v3s60_48d37c79:
    ...
    li "在与许多不同的人交谈时，被倾听是至关重要的，但更重要的是，一个强有力的总统必须能够倾听姐妹们的需求。"
...
translate chinese v3s60_aa0160b4:
    ...
    li "我认为一个好总统应该是一个能让所有人都开心的人，你知道吗？"
...
translate chinese v3s60_d396d4b5:
    ...
    el "那当然很理想，但我不确定这是否是一种品质，你能说得更具体一点吗？"
...
translate chinese v3s60_ed8292fe:
    ...
    li "比如，如果有人给我做了早餐他们知道我想在煎饼上放蓝莓但总统在上面放了蜂蜜。"
...
translate chinese v3s60_c677d463:
    ...
    el "所以你的意思是，一个好总统应该知道你喜欢在煎饼上放什么？"
...
translate chinese v3s60_95cc168f:
    ...
    el "我觉得让人们知道你是个好人很重要。告诉我，你最近有没有做过什么事来帮助别人而不是你自己？"
...
translate chinese v3s60_b92e8662:
    ...
    li "当我年轻的时候，我会捐出我所有的零用钱来帮助拯救热带雨林，哈。也许那一个，仍然。"
...
translate chinese v3s60_c3b67d5e:
    ...
    li "我给当地的狗狗慈善机构捐了钱！今天才重新开放，他们需要尽可能多的支持。"
...
translate chinese v3s60_0be22e61:
    ...
    ri "好吧，这里有一个有趣的问题。你钦佩你的总统竞选对手什么？"
...
translate chinese v3s60_8f2f449a:
    ...
    li "不得不说，克洛伊是个很棒的对手，我仍然把她当作我的朋友，我的姐妹会姐妹。"
...
translate chinese v3s60_0a553980:
    ...
    li "我钦佩她所做的出色工作，像这样的总统竞选不容易受到挑战。"
...
translate chinese v3s60_a82d69ea:
    ...
    li "好吧，很明显她很性感，我是说，我很欣赏她的长相，如果我可以这么说的话。"
...
translate chinese v3s60_3d0d25ea:
    ...
    ri "我很想知道: 你是否认为每个成功的总统都应该具备某种特定的品质？"
...
translate chinese v3s60_6fdb998c:
    ...
    li "这是人际交往技巧。作为总统，你必须具备出色的人际交往能力。更具体地说，你需要成为一个有效的沟通者。"
...
translate chinese v3s60_b92cc758:
    ...
    li "一个好总统应该让每个人都高兴。我认为这是一个基本的品质。不幸的是，克洛伊没能做到。"
...
translate chinese v3s60_af2fd870:
    ...
    ri "请原谅我这样说，但这听起来有点泛滥。你能具体说明一下吗? 你如何让每个人都高兴？"
...
translate chinese v3s60_41295acc:
    ...
    ri "这是一个很好的一个，显示人们你善良的一面。你最近有没有做过什么事来帮助别人而不是你自己？"
...
translate chinese v3s60_493d4d41:
    ...
    li "我给当地的狗狗慈善机构捐了钱。当我看到那里所有被遗弃的狗时，我感到很难过，所以我喜欢尽可能地捐赠。"
...
translate chinese v3s60_ded337de:
    ...
    li "每个人都应该帮忙，即使他们只能寄一美元。那一美元有助于保证狗的安全和喂养良好。"
...
translate chinese v3s60_7bede76e:
    ...
    ri "我一辈子都在它们身边我可以说它们是这个星球上最聪明的生物之一。"
...
translate chinese v3s60_5d4503af:
    ...
    u "(Lindsey 刚刚侮辱了 Riley 她妈妈，还有她妈妈的猫，操)"
...
translate chinese v3s60_c3abf6a6:
    ...
    ri "好了，我想这篇文章就写到这里吧，谢谢你的采访 Lindsey。"
...
translate chinese v3s60_45233ea2:
    ...
    ri "谢谢你注意到了！我用的是美发沙龙推荐的新护发素。我觉得是椰子让它闪闪发光。"
...
translate chinese v3s60_a306be90:
    ...
    li "哦，当然，我很喜欢。我们什么时候一起喝杯咖啡，你能给我一些建议吗？"
...
translate chinese v3s60_ba862ea1:
    ...
    u "(双重打击! 保持专业和适当的赞美。我很高兴她听取了我的建议。)"
