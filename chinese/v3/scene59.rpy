...
translate chinese v3s59_6bc82d78:
    ...
    li "是的，我知道，他们根本不呼吸，他们感觉自己像是用湿羊毛做的。"
...
translate chinese v3s59_e1815cb9:
    ...
    u "只要说几句关于林赛是小鸡队总统的最佳人选而且她得到了你的支持之类的？"
...
translate chinese v3s59_ac48f26a:
    ...
    polly "我对你一无所知，但你费了这么大劲就是为了问我这说明你很有决心。"
...
translate chinese v3s59_1cf8ac03:
    ...
    li "没错，但我已经帮你切好了我已经拿了一块去检查毒药了。* 尴尬的傻笑 * 美味又安全！"
...
translate chinese v3s59_4d6c3313:
    ...
    polly "你可以把它放在地板上，如果可以的话，我的保镖回来的时候可能会有。"
...
translate chinese v3s59_4463bae3:
    ...
    li "在你表演之前还有几个小时。你可以写一首关于一个叫 Lindsey 的女孩的歌"
...
translate chinese v3s59_d9df044e:
    ...
    polly "是啊，不会发生。对不起，伙计们。这是可爱的。但是，祝你的竞选好运！"
...
translate chinese v3s59_0f465207:
    ...
    u "我知道我们无意中发现了你的酒店房间不管你在做什么都会打扰到你，但是。"
...
translate chinese v3s59_943fb204:
    ...
    polly "是的，非常奇怪。但是，请继续。这将成为一个滑稽的 Kiwii 帖子。"
...
translate chinese v3s59_40a32a1e:
    ...
    u "不过说真的，如果你能给我们一点小小的支持只要说琳赛的竞选有你的支持就会对我们大有帮助。"
...
translate chinese v3s59_51728f0f:
    ...
    polly "冷静点，猛男。我今晚已经准备去了所以说几句关于你的事也不是什么大问题。"
...
translate chinese v3s59_4f4ccdcd:
    ...
    polly "答应我你不会变成什么极权独裁者联谊会主席。这会影响我的形象。我现在很喜欢民主政体。"
...
translate chinese v3s59_ea07db20:
    ...
    li "当然，我是在犯傻。你是艺术家。显然，你可以选择歌曲的名称。"
