...
translate chinese v1s16_e9280e8a:
    ...
    cl "我别无选择。我昨晚只是想回家睡觉但我却一直在参与姐妹会的争吵。"
...
translate chinese v1s16_e44684a3:
    ...
    cl "结果发现这玩意至少已经坏了一个星期了。我们不在的时候，她一直有人为她工作。"
...
translate chinese v1s16_00dd30ef:
    ...
    cl "如果我想打败她，我需要很多帮助,[name]. 这不会像我想的那么容易。"
...
translate chinese v1s16_65949493:
    ...
    cl "克里斯已经保证狼队会站在我这边，所以这是一个祝福，但是我最需要的是你的支持。"
...
translate chinese v1s16_9633ce85:
    ...
    cl "我知道我以前问过你，但这次我需要一个最终的答案。你会帮我竞选这样我就能打败琳赛了吗？"
...
translate chinese v1s16_d6818f12:
    ...
    cl "另外，总统总是需要一个助手，如果我的工作是，照顾你，同时管理女生联谊会..。"
...
translate chinese v1s16_4b0dae6a:
    ...
    u "不是我不想，克洛伊。我正忙着过我自己的希腊生活，就这样。我们刚回到学校"
...
translate chinese v1s16_55cba150:
    ...
    u "操。这会给我们带来一些严重的问题。说实话，我有点惊讶她没有立刻和我分手... ... 不管克洛伊愿不愿意。)"
