...
translate chinese v1s19_4be3ae55:
    ...
    cl "对不起[name]，我只是真的很集中和焦虑开始考虑林赛游行已经发生了一整天。"
...
translate chinese v1s19_3ca0e6d1:
    ...
    cl "我竞选的第一阶段就是重建旧的忠诚。我第一次当选的时候，人们喜欢我，我需要提醒他们为什么。"
...
translate chinese v1s19_continue_1bf4d4fe:
    ...
    cl "如果我们成功了，小鸡和猩猩的联盟会给小鸡们带来一个有趣的未来。"
...
translate chinese v1s19_continue_ad57e28d:
    ...
    cl "我知道克里斯信任我所以我很确定狼人已经站在我们这边了。不过我们会知道的。"
...
translate chinese v1s19_continue_10c0579b:
    ...
    cl "我告诉她我们会处理的。一切都很好，如果你不按时交表，学校会大惊小怪的。"
