...
translate chinese strings:
    ...
    new "我刚匿名发了电子票。她现在有很多崇拜者。可能只是以为是他们其中一个送的礼物。很简单吧？"
