...
translate chinese v1s17_f8a7d4b2:
    ...
    ro "我们不在的时候，我让助教给你做了笔记。你和你的搭档一起检查。"
...
translate chinese v1s17_427e531f:
    ...
    ro "你今天要和劳伦在一起，我想让我最聪明的学生和班上的小丑配对。"
...
translate chinese v1s17_304da2e6:
    ...
    u "你说得倒轻巧！你基本上是和我搭档来教我的。这些你都知道了。"
...
translate chinese v1s17_0f25d506:
    ...
    la "我会给你们发一份助教的笔记你们可以用自己的时间仔细考虑。"
...
translate chinese v1s17_ff626990:
    ...
    la "我一直很喜欢糕点义卖，但我不想掺和进来。你看到她所有的传单了吗？"
...
translate chinese v1s17_cf832f26:
    ...
    la "不过我也得承认，林赛有很强的领导潜力还有很多新点子不仅能让小妞们受益还能让所有姐妹会受益。"
...
translate chinese v1s17_9a3e0a4a:
    ...
    u "我们都知道你是个很棒的面包师，显然 Lindsey 也知道，所以我觉得你应该帮帮她。"
...
translate chinese v1s17_4293aa9a:
    ...
    u "是的。Lindsey 从她决定竞选总统的那一刻起就一直在拼命工作。她关心小妞们。"
...
translate chinese v1s17_e1267aea:
    ...
    u "如果她来找你只是为了另一场糕点义卖那就不一样了但这是一场有着隐藏目的的糕点义卖。"
...
translate chinese v1s17_e301f69e:
    ...
    u "这是克洛伊的最后一年如果我能阻止琳赛接手，我就会这么做。她不需要当总统。"
...
translate chinese v1s17_6a8ae0f5:
    ...
    la "我想你也是我的唯一。你肯定觉得 Lindsey 和 Chloe 竞争是越界了，对吧？"
...
translate chinese v1s17_ed1621dd:
    ...
    u "- 你说得好像没事一样-Lauren 太好了，没有你一切都会变糟的。"
...
translate chinese v1s17_c3c6dc4e:
    ...
    la "没错，你认识的最忠诚的人所以你应该最清楚我不会做这种事。"
